...
# Amway: KL Hop-On Hop-Off — экскурсии (в приложение)

## Outcome
- Готовый дизайн файла “Автобусный тур KL Hop‑On Hop‑Off” в стиле KV LTS Malaysia + адаптация на 4 языка для загрузки в мобильное приложение мероприятия.
